    ...
    <div className="mx-auto max-w-6xl px-4 md:px-6 py-12 md:py-16">
      <header className="mb-10 max-w-3xl">
        ...
        <p className="text-muted-foreground mt-3 leading-relaxed">
          Each lab calls a server route that proxies to the Anthropic API with prompt
          caching, structured outputs, and adaptive thinking. You&apos;ll need an{" "}
          <code className="text-foreground bg-muted rounded px-1.5 py-0.5">
            ANTHROPIC_API_KEY
          </code>{" "}
          set in <code className="text-foreground bg-muted rounded px-1.5 py-0.5">.env.local</code>.
          Calls run on the model{" "}
          <code className="text-foreground bg-muted rounded px-1.5 py-0.5">claude-opus-4-7</code>.
        </p>
      </header>
